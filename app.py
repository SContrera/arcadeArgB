...
class Producto(db.Model):  # Producto hereda de db.Model
    ...
    def __init__(self, nombre, descripcion, anio, marca, precio, stock, imagen):
        """
...
class ProductoSchema(ma.Schema):
    ...
    """
    class Meta:
        fields = ("id", "nombre", "descripcion", "anio", "marca", "precio", "stock", "imagen")
...
def create_producto():
    ...
    descripcion = request.json["descripcion"]  # Obtiene el nombre del producto del JSON proporcionado
    anio = request.json["anio"]  # Obtiene el precio del producto del JSON proporcionado
    marca = request.json["marca"]  # Obtiene el precio del producto del JSON proporcionado
    ...
    new_producto = Producto(nombre, descripcion, anio, marca, precio, stock, imagen)  # Crea un nuevo objeto Producto con los datos proporcionados
...
def update_producto(id):
    ...
    producto.anio= request.json["anio"]
